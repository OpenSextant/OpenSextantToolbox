...
public class PhoneticUtils {
	...
	// org.apache.lucene.analysis.miscellaneous.ASCIIFoldingFilter.java
	...
	public static String foldToASCII(String word) {
		...
		for (int pos = 0; pos < word.length(); ++pos) {
			...
			if (c < '\u0080') {
				...
				case '\u018F': // Ə http://en.wikipedia.org/wiki/Schwa [LATIN
								// CAPITAL LETTER SCHWA]
				case '\u01CD': // Ǎ [LATIN CAPITAL LETTER A WITH CARON]
				case '\u01DE': // Ǟ [LATIN CAPITAL LETTER A WITH DIAERESIS AND
								// MACRON]
				case '\u01E0': // Ǡ [LATIN CAPITAL LETTER A WITH DOT ABOVE AND
								// MACRON]
				case '\u01FA': // Ǻ [LATIN CAPITAL LETTER A WITH RING ABOVE AND
								// ACUTE]
				...
				case '\u1EA4': // Ấ [LATIN CAPITAL LETTER A WITH CIRCUMFLEX AND
								// ACUTE]
				case '\u1EA6': // Ầ [LATIN CAPITAL LETTER A WITH CIRCUMFLEX AND
								// GRAVE]
				case '\u1EA8': // Ẩ [LATIN CAPITAL LETTER A WITH CIRCUMFLEX AND
								// HOOK ABOVE]
				case '\u1EAA': // Ẫ [LATIN CAPITAL LETTER A WITH CIRCUMFLEX AND
								// TILDE]
				case '\u1EAC': // Ậ [LATIN CAPITAL LETTER A WITH CIRCUMFLEX AND
								// DOT BELOW]
				case '\u1EAE': // Ắ [LATIN CAPITAL LETTER A WITH BREVE AND
								// ACUTE]
				case '\u1EB0': // Ằ [LATIN CAPITAL LETTER A WITH BREVE AND
								// GRAVE]
				case '\u1EB2': // Ẳ [LATIN CAPITAL LETTER A WITH BREVE AND HOOK
								// ABOVE]
				case '\u1EB4': // Ẵ [LATIN CAPITAL LETTER A WITH BREVE AND
								// TILDE]
				case '\u1EB6': // Ặ [LATIN CAPITAL LETTER A WITH BREVE AND DOT
								// BELOW]
				...
				case '\u01DF': // ǟ [LATIN SMALL LETTER A WITH DIAERESIS AND
								// MACRON]
				case '\u01E1': // ǡ [LATIN SMALL LETTER A WITH DOT ABOVE AND
								// MACRON]
				case '\u01FB': // ǻ [LATIN SMALL LETTER A WITH RING ABOVE AND
								// ACUTE]
				...
				case '\u1D95': // ᶕ [LATIN SMALL LETTER SCHWA WITH RETROFLEX
								// HOOK]
				...
				case '\u1EA5': // ấ [LATIN SMALL LETTER A WITH CIRCUMFLEX AND
								// ACUTE]
				case '\u1EA7': // ầ [LATIN SMALL LETTER A WITH CIRCUMFLEX AND
								// GRAVE]
				case '\u1EA9': // ẩ [LATIN SMALL LETTER A WITH CIRCUMFLEX AND
								// HOOK ABOVE]
				case '\u1EAB': // ẫ [LATIN SMALL LETTER A WITH CIRCUMFLEX AND
								// TILDE]
				case '\u1EAD': // ậ [LATIN SMALL LETTER A WITH CIRCUMFLEX AND
								// DOT BELOW]
				case '\u1EAF': // ắ [LATIN SMALL LETTER A WITH BREVE AND ACUTE]
				case '\u1EB1': // ằ [LATIN SMALL LETTER A WITH BREVE AND GRAVE]
				case '\u1EB3': // ẳ [LATIN SMALL LETTER A WITH BREVE AND HOOK
								// ABOVE]
				case '\u1EB5': // ẵ [LATIN SMALL LETTER A WITH BREVE AND TILDE]
				case '\u1EB7': // ặ [LATIN SMALL LETTER A WITH BREVE AND DOT
								// BELOW]
				...
				case '\uA73A': // Ꜻ [LATIN CAPITAL LETTER AV WITH HORIZONTAL
								// BAR]
					out.append('A');
					out.append('V');
					break;
				...
				case '\u1E08': // Ḉ [LATIN CAPITAL LETTER C WITH CEDILLA AND
								// ACUTE]
				...
				case '\u1E09': // ḉ [LATIN SMALL LETTER C WITH CEDILLA AND
								// ACUTE]
				...
				case '\u1E12': // Ḓ [LATIN CAPITAL LETTER D WITH CIRCUMFLEX
								// BELOW]
				...
				case '\u01F1': // Ǳ [LATIN CAPITAL LETTER DZ]
					...
					out.append('Z');
					break;
				case '\u01C5': // ǅ [LATIN CAPITAL LETTER D WITH SMALL LETTER Z
								// WITH CARON]
				...
				case '\u1E14': // Ḕ [LATIN CAPITAL LETTER E WITH MACRON AND
								// GRAVE]
				case '\u1E16': // Ḗ [LATIN CAPITAL LETTER E WITH MACRON AND
								// ACUTE]
				case '\u1E18': // Ḙ [LATIN CAPITAL LETTER E WITH CIRCUMFLEX
								// BELOW]
				case '\u1E1A': // Ḛ [LATIN CAPITAL LETTER E WITH TILDE BELOW]
				case '\u1E1C': // Ḝ [LATIN CAPITAL LETTER E WITH CEDILLA AND
								// BREVE]
				...
				case '\u1EBE': // Ế [LATIN CAPITAL LETTER E WITH CIRCUMFLEX AND
								// ACUTE]
				case '\u1EC0': // Ề [LATIN CAPITAL LETTER E WITH CIRCUMFLEX AND
								// GRAVE]
				case '\u1EC2': // Ể [LATIN CAPITAL LETTER E WITH CIRCUMFLEX AND
								// HOOK ABOVE]
				case '\u1EC4': // Ễ [LATIN CAPITAL LETTER E WITH CIRCUMFLEX AND
								// TILDE]
				case '\u1EC6': // Ệ [LATIN CAPITAL LETTER E WITH CIRCUMFLEX AND
								// DOT BELOW]
				...
				case '\u025D': // ɝ [LATIN SMALL LETTER REVERSED OPEN E WITH
								// HOOK]
				...
				case '\u1D93': // ᶓ [LATIN SMALL LETTER OPEN E WITH RETROFLEX
								// HOOK]
				case '\u1D94': // ᶔ [LATIN SMALL LETTER REVERSED OPEN E WITH
								// RETROFLEX HOOK]
				...
				case '\u1E1D': // ḝ [LATIN SMALL LETTER E WITH CEDILLA AND
								// BREVE]
				...
				case '\u1EBF': // ế [LATIN SMALL LETTER E WITH CIRCUMFLEX AND
								// ACUTE]
				case '\u1EC1': // ề [LATIN SMALL LETTER E WITH CIRCUMFLEX AND
								// GRAVE]
				case '\u1EC3': // ể [LATIN SMALL LETTER E WITH CIRCUMFLEX AND
								// HOOK ABOVE]
				case '\u1EC5': // ễ [LATIN SMALL LETTER E WITH CIRCUMFLEX AND
								// TILDE]
				case '\u1EC7': // ệ [LATIN SMALL LETTER E WITH CIRCUMFLEX AND
								// DOT BELOW]
				...
				case '\u02AF': // ʯ [LATIN SMALL LETTER TURNED H WITH FISHHOOK
								// AND TAIL]
				...
				case '\uFF48': // ｈ [FULLWIDTH LATIN SMALL LETTER H]
					out.append('h');
					break;
				case '\u01F6': // Ƕ http://en.wikipedia.org/wiki/Hwair [LATIN
				...
				case '\u1E2E': // Ḯ [LATIN CAPITAL LETTER I WITH DIAERESIS AND
								// ACUTE]
				...
				case '\u1E2F': // ḯ [LATIN SMALL LETTER I WITH DIAERESIS AND
								// ACUTE]
				...
				case '\u0284': // ʄ [LATIN SMALL LETTER DOTLESS J WITH STROKE
								// AND HOOK]
				...
				case '\uA742': // Ꝃ [LATIN CAPITAL LETTER K WITH DIAGONAL
								// STROKE]
				case '\uA744': // Ꝅ [LATIN CAPITAL LETTER K WITH STROKE AND
								// DIAGONAL STROKE]
				...
				case '\uA745': // ꝅ [LATIN SMALL LETTER K WITH STROKE AND
								// DIAGONAL STROKE]
				...
				case '\u1E38': // Ḹ [LATIN CAPITAL LETTER L WITH DOT BELOW AND
								// MACRON]
				case '\u1E3A': // Ḻ [LATIN CAPITAL LETTER L WITH LINE BELOW]
				case '\u1E3C': // Ḽ [LATIN CAPITAL LETTER L WITH CIRCUMFLEX
								// BELOW]
				...
				case '\u1E39': // ḹ [LATIN SMALL LETTER L WITH DOT BELOW AND
								// MACRON]
				...
				case '\u014A': // Ŋ http://en.wikipedia.org/wiki/Eng_(letter)
				...
				case '\u1E4A': // Ṋ [LATIN CAPITAL LETTER N WITH CIRCUMFLEX
								// BELOW]
				...
				case '\u0149': // ŉ [LATIN SMALL LETTER N PRECEDED BY
								// APOSTROPHE]
				case '\u014B': // ŋ http://en.wikipedia.org/wiki/Eng_(letter)
				...
				case '\u01EC': // Ǭ [LATIN CAPITAL LETTER O WITH OGONEK AND
								// MACRON]
				case '\u01FE': // Ǿ [LATIN CAPITAL LETTER O WITH STROKE AND
								// ACUTE]
				case '\u020C': // Ȍ [LATIN CAPITAL LETTER O WITH DOUBLE GRAVE]
				case '\u020E': // Ȏ [LATIN CAPITAL LETTER O WITH INVERTED BREVE]
				case '\u022A': // Ȫ [LATIN CAPITAL LETTER O WITH DIAERESIS AND
								// MACRON]
				case '\u022C': // Ȭ [LATIN CAPITAL LETTER O WITH TILDE AND
								// MACRON]
				case '\u022E': // Ȯ [LATIN CAPITAL LETTER O WITH DOT ABOVE]
				case '\u0230': // Ȱ [LATIN CAPITAL LETTER O WITH DOT ABOVE AND
								// MACRON]
				case '\u1D0F': // ᴏ [LATIN LETTER SMALL CAPITAL O]
				case '\u1D10': // ᴐ [LATIN LETTER SMALL CAPITAL OPEN O]
				case '\u1E4C': // Ṍ [LATIN CAPITAL LETTER O WITH TILDE AND
								// ACUTE]
				case '\u1E4E': // Ṏ [LATIN CAPITAL LETTER O WITH TILDE AND
								// DIAERESIS]
				case '\u1E50': // Ṑ [LATIN CAPITAL LETTER O WITH MACRON AND
								// GRAVE]
				case '\u1E52': // Ṓ [LATIN CAPITAL LETTER O WITH MACRON AND
								// ACUTE]
				case '\u1ECC': // Ọ [LATIN CAPITAL LETTER O WITH DOT BELOW]
				case '\u1ECE': // Ỏ [LATIN CAPITAL LETTER O WITH HOOK ABOVE]
				case '\u1ED0': // Ố [LATIN CAPITAL LETTER O WITH CIRCUMFLEX AND
								// ACUTE]
				case '\u1ED2': // Ồ [LATIN CAPITAL LETTER O WITH CIRCUMFLEX AND
								// GRAVE]
				case '\u1ED4': // Ổ [LATIN CAPITAL LETTER O WITH CIRCUMFLEX AND
								// HOOK ABOVE]
				case '\u1ED6': // Ỗ [LATIN CAPITAL LETTER O WITH CIRCUMFLEX AND
								// TILDE]
				case '\u1ED8': // Ộ [LATIN CAPITAL LETTER O WITH CIRCUMFLEX AND
								// DOT BELOW]
				case '\u1EDA': // Ớ [LATIN CAPITAL LETTER O WITH HORN AND ACUTE]
				case '\u1EDC': // Ờ [LATIN CAPITAL LETTER O WITH HORN AND GRAVE]
				case '\u1EDE': // Ở [LATIN CAPITAL LETTER O WITH HORN AND HOOK
								// ABOVE]
				case '\u1EE0': // Ỡ [LATIN CAPITAL LETTER O WITH HORN AND TILDE]
				case '\u1EE2': // Ợ [LATIN CAPITAL LETTER O WITH HORN AND DOT
								// BELOW]
				case '\u24C4': // Ⓞ [CIRCLED LATIN CAPITAL LETTER O]
				case '\uA74A': // Ꝋ [LATIN CAPITAL LETTER O WITH LONG STROKE
								// OVERLAY]
				...
				case '\u01ED': // ǭ [LATIN SMALL LETTER O WITH OGONEK AND
								// MACRON]
				...
				case '\u022B': // ȫ [LATIN SMALL LETTER O WITH DIAERESIS AND
								// MACRON]
				case '\u022D': // ȭ [LATIN SMALL LETTER O WITH TILDE AND MACRON]
				case '\u022F': // ȯ [LATIN SMALL LETTER O WITH DOT ABOVE]
				case '\u0231': // ȱ [LATIN SMALL LETTER O WITH DOT ABOVE AND
								// MACRON]
				...
				case '\u1D97': // ᶗ [LATIN SMALL LETTER OPEN O WITH RETROFLEX
								// HOOK]
				case '\u1E4D': // ṍ [LATIN SMALL LETTER O WITH TILDE AND ACUTE]
				case '\u1E4F': // ṏ [LATIN SMALL LETTER O WITH TILDE AND
								// DIAERESIS]
				...
				case '\u1ED1': // ố [LATIN SMALL LETTER O WITH CIRCUMFLEX AND
								// ACUTE]
				case '\u1ED3': // ồ [LATIN SMALL LETTER O WITH CIRCUMFLEX AND
								// GRAVE]
				case '\u1ED5': // ổ [LATIN SMALL LETTER O WITH CIRCUMFLEX AND
								// HOOK ABOVE]
				case '\u1ED7': // ỗ [LATIN SMALL LETTER O WITH CIRCUMFLEX AND
								// TILDE]
				case '\u1ED9': // ộ [LATIN SMALL LETTER O WITH CIRCUMFLEX AND
								// DOT BELOW]
				case '\u1EDB': // ớ [LATIN SMALL LETTER O WITH HORN AND ACUTE]
				case '\u1EDD': // ờ [LATIN SMALL LETTER O WITH HORN AND GRAVE]
				case '\u1EDF': // ở [LATIN SMALL LETTER O WITH HORN AND HOOK
								// ABOVE]
				case '\u1EE1': // ỡ [LATIN SMALL LETTER O WITH HORN AND TILDE]
				case '\u1EE3': // ợ [LATIN SMALL LETTER O WITH HORN AND DOT
								// BELOW]
				...
				case '\uA74B': // ꝋ [LATIN SMALL LETTER O WITH LONG STROKE
								// OVERLAY]
				...
				case '\uA74E': // Ꝏ [LATIN CAPITAL LETTER OO]
					...
					out.append('O');
					break;
				case '\u0222': // Ȣ http://en.wikipedia.org/wiki/OU [LATIN
								// CAPITAL LETTER OU]
				...
				case '\uA74F': // ꝏ [LATIN SMALL LETTER OO]
					...
					out.append('o');
					break;
				case '\u0223': // ȣ http://en.wikipedia.org/wiki/OU [LATIN SMALL
								// LETTER OU]
					out.append('o');
					out.append('u');
					break;
				...
				case '\uA750': // Ꝑ [LATIN CAPITAL LETTER P WITH STROKE THROUGH
								// DESCENDER]
				...
				case '\uA751': // ꝑ [LATIN SMALL LETTER P WITH STROKE THROUGH
								// DESCENDER]
				...
				case '\u24AB': // ⒫ [PARENTHESIZED LATIN SMALL LETTER P]
					...
					out.append(')');
					break;
				case '\u024A': // Ɋ [LATIN CAPITAL LETTER SMALL Q WITH HOOK
								// TAIL]
				case '\u24C6': // Ⓠ [CIRCLED LATIN CAPITAL LETTER Q]
				case '\uA756': // Ꝗ [LATIN CAPITAL LETTER Q WITH STROKE THROUGH
								// DESCENDER]
				case '\uA758': // Ꝙ [LATIN CAPITAL LETTER Q WITH DIAGONAL
								// STROKE]
				case '\uFF31': // Ｑ [FULLWIDTH LATIN CAPITAL LETTER Q]
					out.append('Q');
					break;
				case '\u0138': // ĸ http://en.wikipedia.org/wiki/Kra_(letter)
								// [LATIN SMALL LETTER KRA]
				case '\u024B': // ɋ [LATIN SMALL LETTER Q WITH HOOK TAIL]
				case '\u02A0': // ʠ [LATIN SMALL LETTER Q WITH HOOK]
				case '\u24E0': // ⓠ [CIRCLED LATIN SMALL LETTER Q]
				case '\uA757': // ꝗ [LATIN SMALL LETTER Q WITH STROKE THROUGH
								// DESCENDER]
				...
				case '\u1E5C': // Ṝ [LATIN CAPITAL LETTER R WITH DOT BELOW AND
								// MACRON]
				...
				case '\u027F': // ɿ [LATIN SMALL LETTER REVERSED R WITH
								// FISHHOOK]
				case '\u1D63': // ᵣ [LATIN SUBSCRIPT SMALL LETTER R]
				case '\u1D72': // ᵲ [LATIN SMALL LETTER R WITH MIDDLE TILDE]
				case '\u1D73': // ᵳ [LATIN SMALL LETTER R WITH FISHHOOK AND
								// MIDDLE TILDE]
				...
				case '\u1E5D': // ṝ [LATIN SMALL LETTER R WITH DOT BELOW AND
								// MACRON]
				...
				case '\u1E64': // Ṥ [LATIN CAPITAL LETTER S WITH ACUTE AND DOT
								// ABOVE]
				case '\u1E66': // Ṧ [LATIN CAPITAL LETTER S WITH CARON AND DOT
								// ABOVE]
				case '\u1E68': // Ṩ [LATIN CAPITAL LETTER S WITH DOT BELOW AND
								// DOT ABOVE]
				...
				case '\u017F': // ſ http://en.wikipedia.org/wiki/Long_S [LATIN
								// SMALL LETTER LONG S]
				...
				case '\u1E65': // ṥ [LATIN SMALL LETTER S WITH ACUTE AND DOT
								// ABOVE]
				case '\u1E67': // ṧ [LATIN SMALL LETTER S WITH CARON AND DOT
								// ABOVE]
				case '\u1E69': // ṩ [LATIN SMALL LETTER S WITH DOT BELOW AND DOT
								// ABOVE]
				case '\u1E9C': // ẜ [LATIN SMALL LETTER LONG S WITH DIAGONAL
								// STROKE]
				...
				case '\u023E': // Ⱦ [LATIN CAPITAL LETTER T WITH DIAGONAL
								// STROKE]
				...
				case '\u1E70': // Ṱ [LATIN CAPITAL LETTER T WITH CIRCUMFLEX
								// BELOW]
				...
				case '\uA766': // Ꝧ [LATIN CAPITAL LETTER THORN WITH STROKE
								// THROUGH DESCENDER]
					out.append('T');
					out.append('H');
					break;
				...
				case '\uA767': // ꝧ [LATIN SMALL LETTER THORN WITH STROKE
								// THROUGH DESCENDER]
					out.append('t');
					out.append('h');
					break;
				...
				case '\u01D5': // Ǖ [LATIN CAPITAL LETTER U WITH DIAERESIS AND
								// MACRON]
				case '\u01D7': // Ǘ [LATIN CAPITAL LETTER U WITH DIAERESIS AND
								// ACUTE]
				case '\u01D9': // Ǚ [LATIN CAPITAL LETTER U WITH DIAERESIS AND
								// CARON]
				case '\u01DB': // Ǜ [LATIN CAPITAL LETTER U WITH DIAERESIS AND
								// GRAVE]
				...
				case '\u1E72': // Ṳ [LATIN CAPITAL LETTER U WITH DIAERESIS
								// BELOW]
				case '\u1E74': // Ṵ [LATIN CAPITAL LETTER U WITH TILDE BELOW]
				case '\u1E76': // Ṷ [LATIN CAPITAL LETTER U WITH CIRCUMFLEX
								// BELOW]
				case '\u1E78': // Ṹ [LATIN CAPITAL LETTER U WITH TILDE AND
								// ACUTE]
				case '\u1E7A': // Ṻ [LATIN CAPITAL LETTER U WITH MACRON AND
								// DIAERESIS]
				...
				case '\u1EEC': // Ử [LATIN CAPITAL LETTER U WITH HORN AND HOOK
								// ABOVE]
				case '\u1EEE': // Ữ [LATIN CAPITAL LETTER U WITH HORN AND TILDE]
				case '\u1EF0': // Ự [LATIN CAPITAL LETTER U WITH HORN AND DOT
								// BELOW]
				...
				case '\u01D6': // ǖ [LATIN SMALL LETTER U WITH DIAERESIS AND
								// MACRON]
				case '\u01D8': // ǘ [LATIN SMALL LETTER U WITH DIAERESIS AND
								// ACUTE]
				case '\u01DA': // ǚ [LATIN SMALL LETTER U WITH DIAERESIS AND
								// CARON]
				case '\u01DC': // ǜ [LATIN SMALL LETTER U WITH DIAERESIS AND
								// GRAVE]
				...
				case '\u1E7B': // ṻ [LATIN SMALL LETTER U WITH MACRON AND
								// DIAERESIS]
				...
				case '\u1EED': // ử [LATIN SMALL LETTER U WITH HORN AND HOOK
								// ABOVE]
				case '\u1EEF': // ữ [LATIN SMALL LETTER U WITH HORN AND TILDE]
				case '\u1EF1': // ự [LATIN SMALL LETTER U WITH HORN AND DOT
								// BELOW]
				...
				case '\uA75E': // Ꝟ [LATIN CAPITAL LETTER V WITH DIAGONAL
								// STROKE]
				...
				case '\u01F7': // Ƿ http://en.wikipedia.org/wiki/Wynn [LATIN
								// CAPITAL LETTER WYNN]
				...
				case '\u021C': // Ȝ http://en.wikipedia.org/wiki/Yogh [LATIN
								// CAPITAL LETTER YOGH]
				...
				case '\u278A': // ➊ [DINGBAT NEGATIVE CIRCLED SANS-SERIF DIGIT
								// ONE]
				...
				case '\u2793': // ➓ [DINGBAT NEGATIVE CIRCLED SANS-SERIF NUMBER
								// TEN]
					out.append('1');
					out.append('0');
					break;
				...
				case '\u275D': // ❝ [HEAVY DOUBLE TURNED COMMA QUOTATION MARK
								// ORNAMENT]
				case '\u275E': // ❞ [HEAVY DOUBLE COMMA QUOTATION MARK ORNAMENT]
				case '\u276E': // ❮ [HEAVY LEFT-POINTING ANGLE QUOTATION MARK
								// ORNAMENT]
				case '\u276F': // ❯ [HEAVY RIGHT-POINTING ANGLE QUOTATION MARK
								// ORNAMENT]
				...
				case '\u275B': // ❛ [HEAVY SINGLE TURNED COMMA QUOTATION MARK
								// ORNAMENT]
				...
				case '\u2773': // ❳ [LIGHT RIGHT TORTOISE SHELL BRACKET
								// ORNAMENT]
				...
				case '\u276B': // ❫ [MEDIUM FLATTENED RIGHT PARENTHESIS
								// ORNAMENT]
				...
				case '\u2E29': // ⸩ [RIGHT DOUBLE PARENTHESIS]
					...
					out.append(')');
					break;
				case '\u276C': // ❬ [MEDIUM LEFT-POINTING ANGLE BRACKET
								// ORNAMENT]
				case '\u2770': // ❰ [HEAVY LEFT-POINTING ANGLE BRACKET ORNAMENT]
				case '\uFF1C': // ＜ [FULLWIDTH LESS-THAN SIGN]
					out.append('<');
					break;
				case '\u276D': // ❭ [MEDIUM RIGHT-POINTING ANGLE BRACKET
								// ORNAMENT]
				case '\u2771': // ❱ [HEAVY RIGHT-POINTING ANGLE BRACKET
								// ORNAMENT]
				...
				// Not in ASCIIFoldingFilter.java
				case '\u01A2':// LATIN CAPITAL LETTER OI
				case '\u01A3':// LATIN SMALL LETTER OI
					out.append('g');
					out.append('h');
					break;
				default:
