...
public class Scorer {
   ...
   * gazetteer. Comparison is based on dist between evidence and gazetteer place. Range = -1.0 -> 1.0 NOTE: these
   * thresholds really should be modulated by FeatureType rather than be absolutes
   * @param evidence
   * @param place
   * @return
   */
