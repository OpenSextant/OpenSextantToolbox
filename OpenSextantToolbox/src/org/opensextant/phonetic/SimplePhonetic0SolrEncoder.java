 ...
 * </ol>
 */
public class SimplePhonetic0SolrEncoder implements StringEncoder {
  @Override
  ...
  public String encode(String word) throws EncoderException {
    ...
    String tmp = PhoneticUtils.removeCase(PhoneticUtils.foldToASCII(PhoneticUtils.removePunctuation(word)));
    return tmp;
  }
}
